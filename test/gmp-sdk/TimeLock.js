...
describe('TimeLock', async () => {
    ...
    it('should revert when scheduling a timelock with invalid hash', async () => {
        ...
        await expect(timeLock.scheduleSetNumByHash(HashZero, eta)).to.be.revertedWithCustomError(timeLock, 'InvalidTimeLockHash');
    });
    ...
    it('should revert when scheduling the same timelock twice', async () => {
        ...
        await expect(timeLock.scheduleSetNum(num, eta)).to.be.revertedWithCustomError(timeLock, 'TimeLockAlreadyScheduled');
    });

    it('should revert when cancelling a timelock with invalid hash', async () => {
        await expect(timeLock.cancelSetNumByHash(HashZero)).to.be.revertedWithCustomError(timeLock, 'InvalidTimeLockHash');
    });
    ...
    it('should revert on executing a timelock with invalid hash', async () => {
        ...
        await expect(timeLock.setNumByHash(HashZero, num)).to.be.revertedWithCustomError(timeLock, 'InvalidTimeLockHash');
    });
