...
import { SafeTokenTransferFrom, SafeTokenTransfer, SafeNativeTransfer } from '../util/SafeTransfer.sol';
...
abstract contract AxelarValuedExpressExecutable is ExpressExecutorTracker {
    ...
    function executeWithToken(
        ...
        {
            (address tokenAddress, uint256 value) = contractCallWithTokenValue(sourceChain, sourceAddress, payload, tokenSymbol, amount);
            _transferToExecutor(expressExecutor, tokenAddress, value);
        }
        ...
        emit ExpressExecutionWithTokenFulfilled(commandId, sourceChain, sourceAddress, payloadHash, tokenSymbol, amount, expressExecutor);
    }
