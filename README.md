...
| [contracts/deploy/Create3.sol](contracts/deploy/Create3.sol)                                           | 76   | This file contains the CreateDeployer contract which deploys new contracts using the `CREATE` opcode and is used as part of the `Create3` deployment method. This file also contains the Create3 library which can be used to deploy a contract with a deterministic address that only depends on the sender and salt, not the contract bytecode. | [ContractAddress.sol](contracts/util/ContractAddress.sol) |
| [contracts/deploy/Create3Deployer.sol](contracts/deploy/Create3Deployer.sol)                           | 71   | This contract is responsible for deploying and initializing new contracts using the CREATE3 technique which ensures that only the sender address and salt influence the deployed address, not the contract bytecode.                                                                                                                              | [Create3.sol](contracts/util/Create3.sol)                 |
| [contracts/upgradable/BaseProxy.sol](contracts/upgradable/BaseProxy.sol)                               | 69   | This abstract contract implements a basic proxy that stores an implementation address. Fallback function calls are delegated to the implementation.                                                                                                                                                                                               | N/A                                                       |
| [contracts/upgradable/FinalProxy.sol](contracts/upgradable/FinalProxy.sol)                             | 90   | The FinalProxy contract is a proxy that can be upgraded to a final implementation that uses less gas than regular proxy calls.                                                                                                                                                                                                                    | N/A                                                       |
| [contracts/interfaces/IFinalProxy.sol](contracts/interfaces/IFinalProxy.sol)                           | 12   | Interface for the FinalProxy contract.                                                                                                                                                                                                                                                                                                            | N/A                                                       |
| [contracts/upgradable/FixedProxy.sol](contracts/upgradable/FixedProxy.sol)                             | 60   | The FixedProxy is a type of Proxy contract with a fixed implementation that cannot be updated.                                                                                                                                                                                                                                                    | N/A                                                       |
| [contracts/upgradable/InitProxy.sol](contracts/upgradable/InitProxy.sol)                               | 64   | A proxy contract that can be initialized to use a specified implementation and owner.                                                                                                                                                                                                                                                             | N/A                                                       |
| [contracts/interfaces/IInitProxy.sol](contracts/interfaces/IInitProxy.sol)                             | 14   | Interface for the InitProxy contract.                                                                                                                                                                                                                                                                                                             | N/A                                                       |
| [contracts/upgradable/Proxy.sol](contracts/upgradable/Proxy.sol)                                       | 45   | A proxy contract that delegates calls to a designated implementation contract.                                                                                                                                                                                                                                                                    | N/A                                                       |
| [contracts/interfaces/IProxy.sol](contracts/interfaces/IProxy.sol)                                     | 16   | Interface for the Proxy contract.                                                                                                                                                                                                                                                                                                                 | N/A                                                       |
| [contracts/upgradable/Upgradable.sol](contracts/upgradable/Upgradable.sol)                             | 88   | This contract provides an interface for upgradable smart contracts and includes the functionality to perform upgrades.                                                                                                                                                                                                                            | N/A                                                       |
| [contracts/interfaces/IUpgradable.sol](contracts/interfaces/IUpgradable.sol)                           | 27   | Interface for the Upgradable contract.                                                                                                                                                                                                                                                                                                            | N/A                                                       |
